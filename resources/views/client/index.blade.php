                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="single-service">
                            <div class="thumb">
                                <img src="{{asset('client/img/s1.jpg')}}" alt="">
                            </div>
                ...
                <div class="row">
                    <div class="active-review-carusel">
                        <div class="single-review item">
                            <img src="{{asset('client/img/r1.png')}}" alt="">
            ...
            <div class="container">
                <div class="row logo-wrap">
                        <a class="col single-img" href="#">
                            <img class="d-block mx-auto" src="{{asset('client/img/l1.png')}}" alt="">
                        </a>
                        <a class="col single-img" href="#">
                            <img class="d-block mx-auto" src="{{asset('client/img/l2.png')}}" alt="">
                        </a>
                        <a class="col single-img" href="#">
                            <img class="d-block mx-auto" src="{{asset('client/img/l3.png')}}" alt="">
                        </a>
                        <a class="col single-img" href="#">
                            <img class="d-block mx-auto" src="{{asset('client/img/l4.png')}}" alt="">
                        </a>
                        <a class="col single-img" href="#">
                            <img class="d-block mx-auto" src="{{asset('client/img/l5.png')}}" alt="">
                        </a>
                </div>	
            </div>	
        </section>
